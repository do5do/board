...
import com.dodo.book.board.config.auth.dto.OAuthAttributes;
import com.dodo.book.board.config.auth.dto.SessionUser;
import com.dodo.book.board.domain.user.User;
import com.dodo.book.board.domain.user.UserRepository;
...
public class CustomOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        // 현재 로그인 진행 중인 서비스를 구분하는 코드 (구글인지 네이버 등인지)
        ...
        // 왜 User class를 사용하지 않고 새로 만드는걸까? => SessionUser class에 있음
